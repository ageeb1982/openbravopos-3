...
public abstract class Formats {
  ...
  public final static Formats LONG = new FormatsLONG();
  ...
  private static final class FormatsLONG extends Formats {
    protected String formatValueInt(Object value) {
      try {
      return m_integerformat.format(((Number) value).longValue());
      } catch (Exception e) {
    ...
    protected Object parseValueInt(String value) throws ParseException {
      return new Long(m_integerformat.parse(value).longValue());
    }
