...
public abstract class Datas {
  ...
  public final static Datas LONG = new DatasLONG();
  ...
  private static final class DatasLONG extends Datas {
    public Object getValue(DataRead dr, int i) throws BasicException {
      return dr.getLong(i);
    }
  ...
  private static final class DatasIMAGE extends Datas {
    ...
    protected String toStringAbstract(Object value) {
      return "0x"
          + ImageUtils.bytes2hex(ImageUtils.writeImage((java.awt.image.BufferedImage) value));
    }
