...
public class ProductsSync implements ProcessAction {
    ...
    public ProductsSync(DataLogicSystem dlsystem, DataLogicIntegration dlintegration, DataLogicSales dlsales, Long warehouse) {
        ...
        try {
            ...
            if (products.length > 0){
                ...
                for (Product product : products) {
                    ...
                    p.setCode(product.getEan() == null || product.getEan().equals("") ? product.getId().toString() : product.getEan());
                    ...
                    if (product instanceof ProductPlus) {
                        ...
                        diary[0] = dlsales.getNextId(ProductInfoEdit.class);
                        diary[1] = now;
                        diary[2] = diff > 0.0 
