...
public class DataLogicIntegration extends BeanFactoryDataSingle {
    ...
    Transaction t = new Transaction(s) {
      public Object transact() throws BasicException {
        ...
        if (new PreparedSentence(s,
            "UPDATE CUSTOMERS SET SEARCHKEY = ?, NAME = ?, NOTES = ?, VISIBLE = " + s.DB.TRUE()
  ...
  public void syncTaxCategory(final TaxCategoryInfo taxcat) throws BasicException {
    ...
    Transaction t = new Transaction(s) {
      public Object transact() throws BasicException {
        ...
        // Try to update
        if (new PreparedSentence(s, "UPDATE TAXCATEGORIES SET NAME = ?  WHERE ID = ?",
            SerializerWriteParams.INSTANCE).exec(new DataParams() {
          public void writeValues() throws BasicException {
            setString(1, taxcat.getName());
            setLong(2, taxcat.getID());
          }
        }) == 0) {

          // If not updated, try to insert
          new PreparedSentence(s, "INSERT INTO TAXCATEGORIES(ID, NAME) VALUES (?, ?)",
              SerializerWriteParams.INSTANCE).exec(new DataParams() {
            public void writeValues() throws BasicException {
              setLong(1, taxcat.getID());
      ...
      public Object transact() throws BasicException {
        ...
        if (new PreparedSentence(
          ...
          public void writeValues() throws BasicException {
            ...
            setLong(2, tax.getTaxCategoryID());
            setLong(3, tax.getTaxCustCategoryID());
            setLong(4, tax.getParentID());
          ...
          new PreparedSentence(
            ...
            public void writeValues() throws BasicException {
              ...
              setLong(3, tax.getTaxCategoryID());
              setLong(4, tax.getTaxCustCategoryID());
              setLong(5, tax.getParentID());
  ...
  public void syncCategory(final CategoryInfo cat) throws BasicException {
    ...
    Transaction t = new Transaction(s) {
      public Object transact() throws BasicException {
        ...
        // Try to update
        if (new PreparedSentence(s, "UPDATE CATEGORIES SET NAME = ?, IMAGE = ? WHERE ID = ?",
            SerializerWriteParams.INSTANCE).exec(new DataParams() {
          public void writeValues() throws BasicException {
          ...
          // If not updated, try to insert
          new PreparedSentence(s, "INSERT INTO CATEGORIES(ID, NAME, IMAGE) VALUES (?, ?, ?)",
              SerializerWriteParams.INSTANCE).exec(new DataParams() {
            public void writeValues() throws BasicException {
              setLong(1, cat.getID());
      ...
      public Object transact() throws BasicException {
        ...
        if (new PreparedSentence(
          ...
          public void writeValues() throws BasicException {
            ...
            setLong(6, prod.getCategoryID());
            setLong(7, prod.getTaxCategoryID());
            setBytes(8, ImageUtils.writeImage(prod.getImage()));
            // setDouble(x, 0.0);
            // setDouble(x, 0.0);
            setLong(9, prod.getID());
          }
        }) == 0) {
          ...
          new PreparedSentence(
              ...
              SerializerWriteParams.INSTANCE).exec(new DataParams() {
            public void writeValues() throws BasicException {
              setLong(1, prod.getID());
              setLong(2, prod.getReference());
              ...
              setLong(9, prod.getCategoryID());
              setLong(10, prod.getTaxCategoryID());
        ...
        // Insert in catalog
        new StaticSentence(s, "INSERT INTO PRODUCTS_CAT(PRODUCT, CATORDER) VALUES (?, NULL)",
  ...
  public List getTicketLines(final Long ticket) throws BasicException {
    return new PreparedSentence(
        s,
        ...
        SerializerWriteLong.INSTANCE, new SerializerReadClass(TicketLineInfo.class)).list(ticket);
  }

  public List getTicketPayments(final Long ticket) throws BasicException {
    return new PreparedSentence(s, "SELECT TOTAL, PAYMENT FROM PAYMENTS WHERE RECEIPT = ?",
        SerializerWriteLong.INSTANCE, new SerializerRead() {
          public Object readValues(DataRead dr) throws BasicException {
            return new PaymentInfoTicket(dr.getDouble(1), dr.getLong(2));
          }
        }).list(ticket);
  }
