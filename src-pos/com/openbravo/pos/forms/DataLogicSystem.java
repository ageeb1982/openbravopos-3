...
public class DataLogicSystem extends BeanFactoryDataSingle {
    ...
    public void init(){
        ...
        Datas[] resourcedata = new Datas[] {Datas.LONG, Datas.STRING, Datas.INT, Datas.BYTES};
        ...
        m_rolepermissions = new PreparedSentence(s
            ...
            , SerializerWriteLong.INSTANCE , SerializerReadBytes.INSTANCE);     
        ...
        m_insertcash = new StaticSentence(s
                , "INSERT INTO CLOSEDCASH(MONEY, HOST, HOSTSEQUENCE, DATESTART, DATEEND) " +
                  "VALUES (?, ?, ?, ?, ?)"
                , new SerializerWriteBasic(new Datas[] {Datas.LONG, Datas.STRING, Datas.INT, Datas.TIMESTAMP, Datas.TIMESTAMP}));
...
//    public abstract BaseSentence getShutdown();
    ...
    public final String findRolePermissions(Long sRole) {
    ...
    public final void setResource(String name, int type, byte[] data) {
        try {
            Object[] value = new Object[] {getNextId(ResourcesView.class), name, new Integer(type), data};
    ...
    public final Object[] findActiveCash(Long sActiveCashIndex) throws BasicException {
    ...
    public final String findLocationName(Long iLocation) throws BasicException {
