...
//    return new File(new File(System.getProperty("user.home")), AppLocal.APP_ID + ".properties");
      return new File(new File("/Users/dante/Desktop/"), AppLocal.APP_ID + ".properties");
  }
  ...
  private void loadDefault() {
    ...
    // m_propsconfig.setProperty("db.URL", "jdbc:derby:" + new File(new
    // File(System.getProperty("user.home")), AppLocal.APP_ID + "-database").getAbsolutePath() +
    // ";create=true");
    ...
    // m_propsconfig.setProperty("db.URL", "jdbc:hsqldb:file:" + new File(new
    // File(System.getProperty("user.home")), AppLocal.APP_ID + "-db").getAbsolutePath() +
    // ";shutdown=true");
    ...
    m_propsconfig.setProperty("db.driver", "oracle.jdbc.driver.Oracledriver");
    m_propsconfig.setProperty("db.URL", "jdbc:oracle:thin:@localhost:1521:XE");
    m_propsconfig.setProperty("db.user", "POS_ADM");
    m_propsconfig.setProperty("db.password", "POS_ADM");
