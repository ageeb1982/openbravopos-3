...
public class JRootApp extends JPanel implements AppView {
    ...
    public boolean initApp(AppProperties props) {
        ...
        try {
            String activecash = m_propsdb.getProperty("activecash");
            Long sActiveCashIndex = activecash == null ? 0L : Long.valueOf(activecash);
            ...
            if (valcash == null || !m_props.getHost().equals(valcash[0])) {
                ...
                setActiveCash(m_dlSystem.getNextId(JPanelCloseMoney.class), m_dlSystem.getSequenceCash(m_props.getHost()) + 1, new Date(), null);
        ...
        String idLocation = m_propsdb.getProperty("location");
        if (idLocation == null) {
            m_sInventoryLocation = 0L;
            m_propsdb.setProperty("location", m_sInventoryLocation.toString());
            m_dlSystem.setResourceAsProperties(m_props.getHost() + "/properties", m_propsdb);
        } else {
            m_sInventoryLocation = Long.valueOf(idLocation);
        }
    ...
    public Long getActiveCashIndex() {
    ...
    public void setActiveCash(Long sIndex, int iSeq, Date dStart, Date dEnd) {
        m_sActiveCashIndex = sIndex;
        m_iActiveCashSequence = iSeq;
        m_dActiveCashDateStart = dStart;
        m_dActiveCashDateEnd = dEnd;
        
        m_propsdb.setProperty("activecash", m_sActiveCashIndex.toString());
        m_dlSystem.setResourceAsProperties(m_props.getHost() + "/properties", m_propsdb);
    }   
    ...
    private void initComponents() {
        ...
        jLabel1.setText("<html><center>" +
            "Copyright \u00A9 2015-1016 My Dog Day Care<br><br>" +
            "http://www.mydogdaycare.com.mx<br><br>" +
            "Av México 3169, Monraz, 44670 Guadalajara, Jalisco<br><br>"+
            "33 3121 4623<br><br>"+
            "Este punto de venta esta basado en Openbravo.<br>"+
            "</center>");
