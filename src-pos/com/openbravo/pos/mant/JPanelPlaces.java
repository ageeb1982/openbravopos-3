...
public class JPanelPlaces extends JPanelTable {
    ...
    protected void init() {
        ...
        tplaces = new TableDefinition(app.getSession(),
            ...
            , new Datas[] {Datas.LONG, Datas.STRING, Datas.INT, Datas.INT, Datas.LONG}
            , new Formats[] {Formats.LONG, Formats.STRING, Formats.INT, Formats.INT, Formats.NULL}
            , new int[] {0}
        ); 
        jeditor = new PlacesEditor(app, dirty); 
    }
