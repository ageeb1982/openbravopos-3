...
public class ThirdPartiesView extends javax.swing.JPanel implements EditorRecord {
  ...
  public ThirdPartiesView(AppView app, DirtyManager dirty) {
    ...
    m_jRFC.getDocument().addDocumentListener(dirty);
  ...
  public void writeValueDelete(Object value) {
    ...
    m_oId = (Long) thirdparty[0];
    m_jRFC.setText((String) thirdparty[1]);
  ...
  public Object createValue() throws BasicException {
    ...
    thirdparty[0] = m_oId == null ? dlReceipts.getNextId(ThirdPartiesView.class) : m_oId;
    thirdparty[1] = m_jRFC.getText();
  ...
  private void initComponents() {
    ...
    m_jRFC = new javax.swing.JTextField();
    ...
    add(m_jRFC);
    m_jRFC.setBounds(110, 20, 270, 19);
    ...
    jLabel14.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0, new java.awt.Color(
        0, 0, 0)));
    add(jLabel14);
    jLabel14.setBounds(20, 160, 520, 16);

    jLabel15.setText("Pagos");
    jLabel15.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0, new java.awt.Color(
        0, 0, 0)));
    add(jLabel15);
    jLabel15.setBounds(20, 310, 520, 16);

    jLabel16.setText("Notas");
    jLabel16.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0, new java.awt.Color(
        0, 0, 0)));
    add(jLabel16);
  ...
  private javax.swing.JTextField m_jRFC;
