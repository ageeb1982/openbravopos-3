...
public class DataLogicThirdParties extends BeanFactoryDataSingle {
  ...
  public void init() {
    m_tthirdparties = new TableDefinition(s, "THIRDPARTIES", 
        new String[] { "ID", "RFC", "NAME", "ADDRESS", "CONTACTCOMM", "CONTACTFACT", "PAYRULE", "FAXNUMBER", "PHONENUMBER",
        "MOBILENUMBER", "EMAIL", "WEBPAGE", "NOTES" }, 
        ...
        new Formats[] { Formats.LONG, Formats.STRING, 
        Formats.STRING, Formats.STRING, Formats.STRING, Formats.STRING, Formats.STRING, Formats.STRING, 
        Formats.STRING, Formats.STRING, Formats.STRING, Formats.STRING, Formats.STRING }, new int[] { 0 });
