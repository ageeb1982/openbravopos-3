...
public class ProductsWarehousePanel extends JPanelTable2 {
    ...
    protected void init() {   
        ...
        row = new Row(
                ...
                new Field("PRODUCT_ID", Datas.LONG, Formats.LONG),
                new Field(AppLocal.getIntString("label.prodref"), Datas.STRING, Formats.STRING, true, true, true),
                new Field(AppLocal.getIntString("label.prodname"), Datas.STRING, Formats.STRING, true, true, true),
                new Field("LOCATION", Datas.LONG, Formats.LONG),
        ...
        lpr = new ListProviderCreator(new PreparedSentence(app.getSession(),
                ...
                "ORDER BY P.NAME",
                new SerializerWriteBasicExt(new Datas[] {Datas.LONG, Datas.LONG}, new int[]{1, 1}),
        ...
        SentenceExec updatesent =  new SentenceExecTransaction(app.getSession()) {
            public int execInTransaction(Object params) throws BasicException {
                ...
                if (values[0] == null)  {
                    ...
                    values[0] = dlSales.getNextId(ProductsWarehousePanel.class);
