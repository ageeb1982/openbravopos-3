...
public class PaymentInfoTicket extends PaymentInfo implements SerializableRead  {
    ...
    private Long m_sName;
    private String m_transactionID;
    
    /** Creates a new instance of PaymentInfoCash */
    public PaymentInfoTicket(double dTicket, Long sName) {
        m_sName = sName;
        m_dTicket = dTicket;
    }
    
    public PaymentInfoTicket(double dTicket, Long sName, String transactionID) {
        m_sName = sName;
        m_dTicket = dTicket;
