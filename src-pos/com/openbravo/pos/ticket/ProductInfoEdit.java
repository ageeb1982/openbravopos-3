...
public class ProductInfoEdit {
    ...
    protected Long m_sCategoryID;    
    protected Long m_sTaxID;
    protected Long attributeuseid;
    ...
    public ProductInfoEdit() {
        m_ID = null;
        m_sRef = Constants.PRODUCT_ZERO_REF;
        m_sCode = Constants.PRODUCT_ZERO_REF;
        m_sName = null;
        m_bCom = false;
        m_bScale = false;
        m_sCategoryID = null;
    ...
    public final void setTaxID(Long sTaxID) {
        m_sTaxID = sTaxID;
    }
    public final Long getAttributeUseID() {
        return attributeuseid;
    }
    public final void setAttributeUseID(Long value) {
