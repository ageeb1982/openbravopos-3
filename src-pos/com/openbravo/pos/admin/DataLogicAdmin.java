...
public class DataLogicAdmin extends BeanFactoryDataSingle {
    ...
    public void init(){
        m_tpeople = new TableDefinition(s,
            ...
            , new Datas[] {Datas.LONG, Datas.STRING, Datas.STRING, Datas.LONG, Datas.BOOLEAN, Datas.STRING, Datas.IMAGE}
            , new Formats[] {Formats.LONG, Formats.STRING, Formats.STRING, Formats.LONG, Formats.BOOLEAN, Formats.STRING, Formats.NULL}
            , new int[] {0}
        );   
        ...
        m_troles = new TableDefinition(s,
            ...
            , new Datas[] {Datas.LONG, Datas.STRING, Datas.BYTES}
            , new Formats[] {Formats.LONG, Formats.STRING, Formats.NULL}
            , new int[] {0}
        );  
        ...
        m_tresources = new TableDefinition(s,
            ...
            , new Datas[] {Datas.LONG, Datas.STRING, Datas.INT, Datas.BYTES}
            , new Formats[] {Formats.LONG, Formats.STRING, Formats.INT, Formats.NULL}
            , new int[] {0}
        );           
    }
