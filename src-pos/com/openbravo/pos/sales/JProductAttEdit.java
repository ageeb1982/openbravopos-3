...
import com.openbravo.data.loader.SerializerReadLong;
...
public class JProductAttEdit extends javax.swing.JDialog {
    ...
    private PreparedSentence nextAttSetIns;
    private PreparedSentence nextAttIns;

    private List<JProductAttEditI> itemslist;
    private Long attsetid;
    private Long attInstanceId;
    ...
    private void init(Session s) {
        ...
        nextAttSetIns = new PreparedSentence(s, "SELECT SEQ_ATTRIBUTE_SET_INS.NEXTVAL() FROM DUAL", SerializerWriteString.INSTANCE,
            new SerializerRead() {
        ...
        nextAttIns = new PreparedSentence(s, "SELECT SEQ_ATTRIBUTE_INS.NEXTVAL() FROM DUAL", SerializerWriteString.INSTANCE,
            new SerializerRead() {
              public Object readValues(DataRead dr) throws BasicException {
                return dr.getLong(1);
              }
        ...
        attsetSave = new PreparedSentence(s,
                ...
                new SerializerWriteBasic(Datas.LONG, Datas.LONG, Datas.STRING));
        attinstSave = new PreparedSentence(s,
                "INSERT INTO ATTRIBUTEINSTANCE(ID, ATTRIBUTESETINSTANCE_ID, ATTRIBUTE_ID, VALUE) VALUES (?, ?, ?, ?)",
                new SerializerWriteBasic(Datas.LONG, Datas.LONG, Datas.LONG, Datas.STRING));
        ...
        attinstSent = new PreparedSentence(s, "SELECT A.ID, A.NAME, " + s.DB.CHAR_NULL() + ", " + s.DB.CHAR_NULL() + " " +
            ...
            new SerializerRead() { public Object readValues(DataRead dr) throws BasicException {
                return new AttributeInstInfo(dr.getLong(1), dr.getString(2), dr.getLong(3), dr.getString(4));
            }});
        attinstSent2 = new PreparedSentence(s, "SELECT A.ID, A.NAME, AI.ID, AI.VALUE " +
            ...
            "ORDER BY AU.LINENO",
            new SerializerWriteBasic(Datas.LONG, Datas.LONG),
            new SerializerRead() { public Object readValues(DataRead dr) throws BasicException {
                return new AttributeInstInfo(dr.getLong(1), dr.getString(2), dr.getLong(3), dr.getString(4));
            }});
    ...
    public void editAttributes(Long attsetid, Long attsetinstid) throws BasicException {
    ...
    public Long getAttributeSetInst() {
    ...
    public static class AttributeInstInfo {
        ...
        public AttributeInstInfo(Long attid, String attname, Long id, String value) {
            this.attid = attid;
    ...
    private void m_jButtonOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_m_jButtonOKActionPerformed
        ...
        if (description.length() == 0) {
            ...
            try {
                ...
                id = (Long) attsetinstExistsSent.find(attsetid, description.toString());
            ...
            if (id == null) {
                ...
                try {
                    id = (Long) nextAttSetIns.fetchOne(null);
                    attsetSave.exec(attsetid, description.toString());
                    Long idAttributeInstance = null;
                    for (JProductAttEditI item : itemslist) {
                      idAttributeInstance = (Long) nextAttIns.fetchOne(null);
                      attinstSave.exec(idAttributeInstance, id, item.getAttribute(), item.getValue());
                    }
