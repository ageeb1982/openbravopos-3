...
public class TaxesLogic {
    ...
    private Map<Long, TaxesLogicElement> taxtrees;
    
    public TaxesLogic(List<TaxInfo> taxlist) {
        this.taxlist = taxlist;
      
        taxtrees = new HashMap<Long, TaxesLogicElement>();
        ...
        HashMap<Long, TaxesLogicElement> taxorphans = new HashMap<Long, TaxesLogicElement>();
    ...
    private TicketTaxInfo searchTicketTax(List<TicketTaxInfo> l, Long id) {
    ...
    public double getTaxRate(Long tcid, Date date) {
    ...
    public double getTaxRate(Long tcid, Date date, CustomerInfoExt customer) {
    ...
    public TaxInfo getTaxInfo(Long tcid, Date date) {
        return getTaxInfo(new TaxCategoryInfo(tcid, ""), date, null);
    }
    
    public TaxInfo getTaxInfo(TaxCategoryInfo tc, Date date) {
        return getTaxInfo(tc, date, null);
    }
    ...
    public TaxInfo getTaxInfo(Long tcid, Date date, CustomerInfoExt customer) {
