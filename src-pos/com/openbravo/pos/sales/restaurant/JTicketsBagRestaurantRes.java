...
public class JTicketsBagRestaurantRes extends javax.swing.JPanel implements EditorRecord {
  ...
  public JTicketsBagRestaurantRes(AppView oApp, JTicketsBagRestaurantMap restaurantmap) {
    ...
    ListProvider lpr = new ListProviderCreator(dlCustomers.getReservationsList(),
        new MyDateFilter());
  ...
  public void writeValueDelete(Object value) {
    ...
    CustomerInfo c = new CustomerInfo((Long) res[3]);
    c.setTaxid((Long) res[4]);
  ...
  public Object createValue() throws BasicException {
    ...
    res[0] = m_sID == null ? dlCustomers.getNextId(JTicketsBagRestaurantRes.class) : m_sID;
  ...
  private void initComponents() {
    ...
    m_jbtnTables.setIcon(new javax.swing.ImageIcon(getClass().getResource(
        "/com/openbravo/images/atlantikdesignersmall.png"))); // NOI18N
    ...
    m_jbtnReceive.setIcon(new javax.swing.ImageIcon(getClass().getResource(
        "/com/openbravo/images/mime.png"))); // NOI18N
