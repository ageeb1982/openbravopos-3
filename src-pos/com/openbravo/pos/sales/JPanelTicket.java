...
//    private ScriptObject scriptobjinst;
    ...
    private void addTicketLine(ProductInfoExt oProduct, double dMul, double dPrice) {   
        ...
        TaxInfo tax = taxeslogic.getTaxInfo(new TaxCategoryInfo(oProduct.getTaxCategoryID(), ""), m_oTicket.getDate(), m_oTicket.getCustomer());
    ...
    private double includeTaxes(Long tcid, double dValue) {
        if (m_jaddtax.isSelected()) {
            TaxInfo tax = taxeslogic.getTaxInfo(new TaxCategoryInfo(tcid, ""),  m_oTicket.getDate(), m_oTicket.getCustomer());
    ...
    private void btnSplitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSplitActionPerformed
      try {
        if (m_oTicket.getLinesCount() > 0) {
            ...
            ticket1.setId(dlSales.getNextId(TicketInfo.class));
            TicketInfo ticket2 = new TicketInfo();
            ticket2.setId(dlSales.getNextId(TicketInfo.class));
