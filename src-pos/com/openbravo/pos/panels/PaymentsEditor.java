...
public class PaymentsEditor extends javax.swing.JPanel implements EditorRecord {
    ...
    public PaymentsEditor(AppView app, DirtyManager dirty) {
        ...
        m_ReasonModel.add(new PaymentReasonPositive(PaymentMethod.CASH_IN.getKey(), AppLocal.getIntString("transpayment.cashin")));
        m_ReasonModel.add(new PaymentReasonNegative(PaymentMethod.CASH_OUT.getKey(), AppLocal.getIntString("transpayment.cashout")));              
    ...
    public void writeValueInsert() {
        ...
        m_sPaymentId = null;
        datenew = null;
        setReasonTotal(PaymentMethod.CASH_IN.getKey(), null);
    ...
    public void writeValueDelete(Object value) {
        ...
        m_sId = (Long) payment[0];
        datenew = (Date) payment[2];
        m_sPaymentId = (Long) payment[3];
    ...
    public Object createValue() throws BasicException {
        ...
        payment[0] = m_sId == null ? dlSales.getNextId(SimpleReceipt.class) : m_sId;
        payment[1] = m_App.getActiveCashIndex();
        payment[2] = datenew == null ? new Date() : datenew;
        payment[3] = m_sPaymentId == null ? dlSales.getNextId(PaymentsEditor.class) : m_sPaymentId;
    ...
    private static abstract class PaymentReason implements IKeyed {
        ...
        public PaymentReason(Long key, String text) {
            m_sKey = key;
            m_sText = text;
        }
        public Long getKey() {
    ...
    private static class PaymentReasonPositive extends PaymentReason {
        public PaymentReasonPositive(Long key, String text) {
            super(key, text);
        }
    ...
    private static class PaymentReasonNegative extends PaymentReason {
        public PaymentReasonNegative(Long key, String text) {
            super(key, text);
        }
        public Double positivize(Double d) {
